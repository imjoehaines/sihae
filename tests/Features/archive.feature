Feature: Archive page
  ...
  Scenario: Visiting a Sihae blog with multiple pages of blog posts
    ...
    And I am on "/archive"
    Then I should see "2016 5th May — Penny's Perfect Post"
    And I should see "2015 4th April — Penny's Alright Post"
    And I should see "2014 3rd March — Penny's Premium Post"
    And I should see "2013 2nd February — Penny's P-repetive Post"
    And I should see "2012 1st January — Penny pls stop"
